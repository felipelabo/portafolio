...
export default function myselfLayout({children}: {children: React.ReactNode}) {
    ...
    return(
        <motion.div 
            className='w-[100vw] h-[100svh] flex flex-col sm:px-[2svw] px-[5svw] pb-[2svw] items-center'
        ...
        >
            <motion.div className="w-full mt-[9svh]">
                <motion.h1 className="texto-titulos text-[10svw] sm:text-[7svw]">Sobre Mi</motion.h1>
            </motion.div>
            {children}
        </motion.div> 
    )
